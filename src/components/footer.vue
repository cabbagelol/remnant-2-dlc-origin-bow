      ...
      <svg height="50" xmlns="http://www.w3.org/2000/svg" width="50">
        <g transform="scale(.4) translate(50, 12)">
          ...
          <path
              ...
              fill-opacity="null" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#fff"></path>
        </g>
      </svg>

      <svg t="1599670208146" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
           p-id="6842" width="15" height="15" style="width: 50px;">
        <path
